...
{
    header("location: products.php"); // deal with invalid input
    exit();
}
...
/* Perform query */
$query = "UPDATE product set visible=0 WHERE id = :id";
...
echo "<a href='products.php'>Click here to delete another record</a>";
?>
</body>
</html>